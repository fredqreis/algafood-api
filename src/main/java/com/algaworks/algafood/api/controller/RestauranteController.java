...
//		
//		MappingJacksonValue restaurantesMapper = new MappingJacksonValue(restaurantesModel);
//		
//		restaurantesMapper.setSerializationView(RestauranteView.Resumo.class);
//		
//		if ("apenas-nome".equals(projecao)) {
//			restaurantesMapper.setSerializationView(RestauranteView.ApenasNome.class);
//		} else if ("completo".equals(projecao)) {
//			restaurantesMapper.setSerializationView(null);
//		}
//		
//		return restaurantesMapper;
//	}
//
//	@GetMapping
//	public List<RestauranteModel> listar() {
